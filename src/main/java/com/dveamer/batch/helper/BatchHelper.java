...
public class BatchHelper {
    ...
    public static final int CUSOR_DEFAULT_SIZE = 10;
    public static final int CUSOR_DEFAULT_SIZE_FOR_LIGHT_PROCESS = 100;
    public static final int CHUNK_DEFAULT_SIZE = 100;
    public static final int CHUNK_DEFAULT_BIG_SIZE = 100;
    ...
    public static PreparedStatementSetter pss(String sql, Map namedParameters) {
